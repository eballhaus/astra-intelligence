...
class RealisticShadowEvidenceLearningLabV1:
    ...
    def _build(self, statuses: dict[str, dict[str, Any]]) -> dict[str, Any]:
        ...
        out = {
            ...
            "candidate_lessons": [],
            "candidate_lesson_count": int(high_value_lessons + compressed_lessons),
            "candidate_lesson_shape": "list",
            "candidate_lesson_classification_requires_rows": "aggregate_counts_are_not_candidate_rows; classification consumes the rejection ledger later-price evidence",
