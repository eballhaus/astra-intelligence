...
class LearningFreshnessPlanner:
    ...
    def status(self, *, market_status: str = "unknown") -> dict[str, Any]:
        ...
        return {
            ...
            "paper_trade_learning_fields_shadow": {
                "opportunity_score_at_entry": "planned",
                "expected_return_pct_at_entry": "planned",
                "target_zone_at_entry": "planned",
                "stop_at_entry": "planned",
                "exit_score_at_exit": "planned",
                "target_hit_status": "planned",
                "premature_exit_flag": "planned",
                "late_exit_flag": "planned",
                "missed_profit_flag": "planned",
                "realized_return_pct": "planned",
                "realized_R_multiple": "planned",
                "target_accuracy_score": "planned",
                "exit_quality_score": "planned",
                "mode": "shadow_paper_learning_schema_no_live_trading_change",
            },
