...
class ProviderDataKnowledgeV2:
    ...
    def knowledge_roi(self) -> dict[str, Any]:
        ...
        return {
            ...
            "status": "PASS" if indexes else "INSUFFICIENT_EVIDENCE",
            "generated_at": _now(),
            ...
            "stale_records": stale,
            "index_coverage_pct": round((indexed / max(1, eligible)) * 100.0, 3),
            ...
            "useful_records_per_call": round(useful / max(1, calls), 4),
