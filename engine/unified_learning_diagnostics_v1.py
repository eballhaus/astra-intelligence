...
class UnifiedLearningDiagnosticsV1:
    ...
    def _astra_horizon_lifecycle_capacity_promotion_readiness_bundle_v1_summary(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "shadow_scalp_candidates": _to_int(data.get("shadow_scalp_candidates"), 0),
            "shadow_day_trade_candidates": _to_int(data.get("shadow_day_trade_candidates"), 0),
            "shadow_swing_trade_candidates": _to_int(data.get("shadow_swing_trade_candidates"), 0),
            "qualified_scalp_candidates": _to_int(data.get("qualified_scalp_candidates"), 0),
            "qualified_day_trade_candidates": _to_int(data.get("qualified_day_trade_candidates"), 0),
            "qualified_swing_trade_candidates": _to_int(data.get("qualified_swing_trade_candidates"), 0),
            "missing_horizon_field_count": _to_int(data.get("missing_horizon_field_count"), 0),
            "missing_horizon_field_examples": list(data.get("missing_horizon_field_examples") or [])[:5],
            "horizon_assignment_dropoff_point": _text(data.get("horizon_assignment_dropoff_point"), "insufficient_data"),
            "horizon_assignment_blocker": _text(data.get("horizon_assignment_blocker"), "insufficient_data"),
            "practice_bucket_blocker": _text(data.get("practice_bucket_blocker"), "insufficient_data"),
            "paper_tie_breaker_blocker": _text(data.get("paper_tie_breaker_blocker"), "insufficient_data"),
            "next_required_fix": _text(data.get("next_required_fix"), "collect_more_horizon_evidence"),
            ...
            "adaptive_portfolio_rotation_status": _text(data.get("adaptive_portfolio_rotation_status") or rotation.get("portfolio_rotation_status"), "advisory_monitoring"),
            "stale_positions_count": _to_int(data.get("stale_positions_count") or rotation.get("stale_positions_count"), 0),
            "top_stale_positions": list(data.get("top_stale_positions") or rotation.get("top_stale_positions") or [])[:5],
            "best_replacement_candidates": list(data.get("best_replacement_candidates") or rotation.get("best_replacement_candidates") or [])[:5],
            "capital_trapped_score": _to_float(data.get("capital_trapped_score") or rotation.get("capital_trapped_score"), 0.0),
            "trapped_capital_score": _to_float(data.get("trapped_capital_score") or rotation.get("trapped_capital_score"), 0.0),
            "scalp_learning_blocked": bool(data.get("scalp_learning_blocked") or rotation.get("scalp_learning_blocked", False)),
            "day_learning_blocked": bool(data.get("day_learning_blocked") or rotation.get("day_learning_blocked", False)),
            "swing_overconcentration": bool(data.get("swing_overconcentration") or rotation.get("swing_overconcentration", False)),
            "stale_swing_pressure": _to_float(data.get("stale_swing_pressure") or rotation.get("stale_swing_pressure"), 0.0),
            "horizon_learning_access_score": _to_float(data.get("horizon_learning_access_score") or rotation.get("learning_access_score"), 0.0),
            "profit_retention_score": _to_float(data.get("profit_retention_score") or lifecycle.get("profit_retention_score"), 0.0),
            "profit_retention_status": _text(data.get("profit_retention_status") or lifecycle.get("profit_retention_status"), "monitoring"),
            "giveback_score": _to_float(data.get("giveback_score") or lifecycle.get("giveback_score"), 0.0),
            "lifecycle_efficiency_score": _to_float(data.get("lifecycle_efficiency_score") or lifecycle.get("lifecycle_efficiency_score"), 0.0),
            "lifecycle_efficiency_status": _text(data.get("lifecycle_efficiency_status") or lifecycle.get("lifecycle_efficiency_status"), "monitoring"),
            "protect_profit_recommendation": _text(data.get("protect_profit_recommendation") or lifecycle.get("protect_profit_recommendation"), "continue_shadow_validation"),
            "reduce_giveback_recommendation": _text(data.get("reduce_giveback_recommendation") or lifecycle.get("reduce_giveback_recommendation"), "monitor_giveback"),
            "thesis_review_recommendation": _text(data.get("thesis_review_recommendation") or lifecycle.get("thesis_review_recommendation"), "monitor_active_theses"),
            "horizon_adjustment_recommendation": _text(data.get("horizon_adjustment_recommendation") or lifecycle.get("horizon_adjustment_recommendation"), "keep_adaptive_horizon_learning"),
            "market_regime": _text(data.get("market_regime") or regime_allocation.get("market_regime"), "unknown"),
            "preferred_horizon_mix": dict(data.get("preferred_horizon_mix") or regime_allocation.get("preferred_horizon_mix") or {}),
            ...
            "promotion_candidate_count": _to_int(data.get("promotion_candidate_count") or promotion_v2.get("promotion_candidate_count"), 0),
            "promotion_readiness_score": _to_float(data.get("promotion_readiness_score") or promotion_v2.get("promotion_readiness_score"), 0.0),
            "shadow_confidence": _to_float(data.get("shadow_confidence") or promotion_v2.get("shadow_confidence"), 0.0),
            "shadow_consensus": _to_float(data.get("shadow_consensus") or promotion_v2.get("shadow_consensus"), 0.0),
            "paper_consensus": _to_float(data.get("paper_consensus") or promotion_v2.get("paper_consensus"), 0.0),
            "promotion_roi": _to_float(data.get("promotion_roi") or promotion_v2.get("promotion_roi"), 0.0),
            "rollback_readiness": _text(data.get("rollback_readiness") or promotion_v2.get("rollback_readiness"), "armed"),
            ...
            "expected_exit_improvement": _to_float(data.get("expected_exit_improvement") or promotion_v2.get("expected_exit_improvement"), 0.0),
            ...
            "horizon_participation_score": _to_float(data.get("horizon_participation_score") or horizon_participation.get("horizon_participation_score"), 0.0),
            ...
            "top_known_symbols": list(data.get("top_known_symbols") or catalyst_context.get("top_known_symbols") or [])[:8],
            ...
            "catalyst_readiness_score": _to_float(data.get("catalyst_readiness_score") or catalyst_context.get("catalyst_readiness_score"), 0.0),
            "catalyst_improvement_rate": _to_float(data.get("catalyst_improvement_rate") or catalyst_context.get("catalyst_improvement_rate"), 0.0),
            ...
            "expected_profit_capture_improvement": _to_float(data.get("expected_profit_capture_improvement") or exit_maturation.get("expected_profit_capture_improvement"), 0.0),
