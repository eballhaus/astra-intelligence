...
class PaperAutopilotEngine:
    ...
    def _candidate_trace_row(
        ...
        trace = {
            ...
            "crypto_final_quote_refresh_attempted": bool(r.get("crypto_final_quote_refresh_attempted", False)),
            "crypto_final_quote_refresh_attempt_count": int(_to_float(r.get("crypto_final_quote_refresh_attempt_count"), 0.0)),
