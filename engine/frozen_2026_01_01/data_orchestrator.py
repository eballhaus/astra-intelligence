...
def get_guardian():
    ...
    if GuardianV7 is None:
        from astra_dashboard.core.guardian.guardian_v7 import GuardianV7 as _G
        GuardianV7 = _G
    return GuardianV7
...
def fetch_live_data(symbols=["AAPL", "TSLA", "AMZN", "MSFT", "GOOG", "NVDA"]):
    ...
    try:
        G = get_guardian()
        guardian = G() if callable(G) else G
    ...
    return enriched
# >>> END OF FILE — ASTRA LIVE DATA ORCHESTRATOR <<<
