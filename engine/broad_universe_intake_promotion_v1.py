...
class BroadUniverseIntakePromotionV1:
    ...
    def _score_symbol(self, sym: str) -> dict[str, Any]:
        ...
        return {
            ...
            "portfolio_risk_score": round(max(45.0, min(88.0, liquidity * 0.55 + (100.0 - min(95.0, volatility)) * 0.25 + quality * 0.20)), 2),
            "portfolio_risk_label": "standard_risk" if cap in {"mega_cap", "large_cap", "mid_cap"} else "controlled_exploration_risk",
            "portfolio_risk_ok": bool(liquidity >= 52.0 and quality >= 56.0),
