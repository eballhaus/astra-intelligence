...
STORE_CATALOG: tuple[dict[str, Any], ...] = (
    ...
    {
        "store": "outcome_labels",
        "path": "outcome_labels_v1.jsonl",
        "owner": "outcome_labeling_v1",
        "writer": "outcome label learning",
        "readers": ["warehouse manager", "historical learning governor", "performance attribution"],
        "evidence_class": "derived_outcome_label",
        "authority": "DERIVED",
        "rebuildable": True,
        "index": "storage_summary_indexes/outcome_labels_v1.jsonl.summary_index.json",
        "retention": "preserve_lineage",
    ...
    {
        "store": "trade_lifecycle_excursion",
        "path": "trade_lifecycle_excursion_v2.jsonl",
        "owner": "trade_lifecycle_excursion_v2",
        "writer": "lifecycle excursion learning",
        "readers": ["warehouse manager", "historical learning governor", "exit learning"],
        "evidence_class": "lifecycle_excursion_learning",
        "authority": "DERIVED",
        "rebuildable": True,
        "index": "storage_summary_indexes/trade_lifecycle_excursion_v2.jsonl.summary_index.json",
        "retention": "bounded_derived_history",
    },
    {
        "store": "adaptive_profit_capture",
        "path": "adaptive_profit_capture_intelligence_v1.jsonl",
        "owner": "adaptive_profit_capture_intelligence_v1",
        "writer": "profit capture learning",
        "readers": ["warehouse manager", "historical learning governor", "profit retention"],
        "evidence_class": "profit_capture_learning",
        "authority": "DERIVED",
        "rebuildable": True,
        "index": "storage_summary_indexes/adaptive_profit_capture_intelligence_v1.jsonl.summary_index.json",
        "retention": "bounded_derived_history",
    },
    {
        "store": "adaptive_execution_exit",
        "path": "adaptive_execution_exit_intelligence_v3.jsonl",
        "owner": "adaptive_execution_exit_intelligence_v3",
        "writer": "execution and exit learning",
        "readers": ["warehouse manager", "historical learning governor", "exit diagnostics"],
        "evidence_class": "execution_exit_learning",
        "authority": "DERIVED",
        "rebuildable": True,
        "index": "storage_summary_indexes/adaptive_execution_exit_intelligence_v3.jsonl.summary_index.json",
        "retention": "bounded_derived_history",
    },
    {
        "store": "exit_learning_expansion",
        "path": "exit_learning_expansion_suite_v1.jsonl",
        "owner": "exit_learning_expansion_suite_v1",
        "writer": "expanded exit learning",
        "readers": ["warehouse manager", "historical learning governor", "exit diagnostics"],
        "evidence_class": "exit_learning",
        "authority": "DERIVED",
        "rebuildable": True,
        "index": "storage_summary_indexes/exit_learning_expansion_suite_v1.jsonl.summary_index.json",
        "retention": "bounded_derived_history",
    },
    {
        "store": "trade_archetype_regime",
        "path": "trade_archetype_regime_intelligence_v1.jsonl",
        "owner": "trade_archetype_regime_intelligence_v1",
        "writer": "archetype and regime learning",
        "readers": ["warehouse manager", "historical learning governor", "Cortex"],
        "evidence_class": "archetype_regime_learning",
        "authority": "DERIVED",
        "rebuildable": True,
        "index": "storage_summary_indexes/trade_archetype_regime_intelligence_v1.jsonl.summary_index.json",
        "retention": "warm_then_cold",
    },
    {
