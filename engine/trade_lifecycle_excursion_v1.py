    ...
    def _build_record(
        ...
        *,
        ...
        return {
            ...
            "asset_class": _to_text(paper_row.get("asset_class") or entry_payload.get("asset_class") or paper_row.get("asset_type") or entry_payload.get("asset_type"), "stock"),
            # Preserve decision lineage for lane-isolated, observational replay.
            "lane_id": _to_text(paper_row.get("lane_id") or entry_payload.get("lane_id") or notes.get("lane_id")),
            "strategy_cohort": _to_text(paper_row.get("strategy_cohort") or entry_payload.get("strategy_cohort") or notes.get("strategy_cohort")),
            "instrument_type": _to_text(paper_row.get("instrument_type") or entry_payload.get("instrument_type") or notes.get("instrument_type")),
            "candidate_id": _to_text(paper_row.get("candidate_id") or entry_payload.get("candidate_id") or notes.get("candidate_id")),
            "recommendation_id": _to_text(paper_row.get("recommendation_id") or entry_payload.get("recommendation_id") or notes.get("recommendation_id")),
            "decision_id": _to_text(paper_row.get("decision_id") or entry_payload.get("decision_id") or notes.get("decision_id")),
            "paper_entry_horizon_style": _to_text(paper_row.get("paper_entry_horizon_style") or entry_payload.get("paper_entry_horizon_style") or paper_row.get("horizon_style") or entry_payload.get("horizon_style")),
            "regime": _to_text(paper_row.get("regime") or entry_payload.get("regime") or notes.get("regime")),
