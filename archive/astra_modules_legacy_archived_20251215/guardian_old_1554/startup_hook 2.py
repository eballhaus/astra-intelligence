...
try:
    ...
    telemetry = None
    guardian_v7.guardian.log(f"⚠️ TelemetryHub not available: {e}", level="warning")
...
def initialize_guardian():
    ...
    try:
        ...
        guardian_v7.guardian.log("🔐 Guardian Startup Hook initialized successfully.")
        guardian_v7.guardian.log(f"📁 Guardian root directory: {guardian_v7.root_dir}")
        guardian_v7.guardian.log(
...
def run_startup_diagnostics():
    ...
    try:
        ...
        guardian_v7.guardian.log(f"❌ Guardian diagnostics failed: {e}", level="error")
        traceback.print_exc()
        return False
...
def start_astra_system(heartbeat_interval: int = 300):
    ...
    guardian_v7.guardian.log("🚀 Starting Astra Intelligence background systems...")
    ...
    try:
        ...
        try:
            ...
            guardian_v7.guardian.log("🧠 GuardianAlertManager running in background.")
        ...
        guardian_v7.guardian.log("🛑 Shutdown signal received.", level="warning")
        shutdown_astra_system()
    except Exception as e:
        guardian_v7.guardian.log(f"❌ Fatal error in startup_hook: {e}", level="error")
        traceback.print_exc()
        shutdown_astra_system()
...
def emit_heartbeat_summary():
    ...
    try:
        ...
        guardian_v7.guardian.log(f"⚠️ Heartbeat telemetry failed: {e}", level="warning")
        traceback.print_exc()
...
def shutdown_astra_system():
    ...
    try:
        ...
        guardian_v7.guardian.log(f"⚠️ Error during shutdown: {e}", level="warning")
        traceback.print_exc()
