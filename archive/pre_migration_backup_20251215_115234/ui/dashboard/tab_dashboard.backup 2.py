# -------------------------------------------------------------------
# 🌌 ASTRA DASHBOARD v4.4 — Optimized Version (Rebuilt Clean)
# -------------------------------------------------------------------
...
guardian_log = getattr(guardian, "guardian_log", lambda msg: print("[LazyGuardian]", msg))
...
if __name__ == "__main__":
    import streamlit as st
    from engine.preload_thread import start_async_preload

    start_async_preload()
    from utils.deferred_imports import deferred_import
