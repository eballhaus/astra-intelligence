...
API_POOL = {
    ...
    "NASDAQ": {"base": "https://data.nasdaq.com/api/v3/datatables/NASDAQOMX/data", "weight": 0.8},
    "DATAJOCKEY": {"base": "https://api.datajockey.io/v0/company/financials", "weight": 1.0},
    "SIMFIN": {"base": "https://backend.simfin.com/api/v3/companies/statements", "weight": 0.9},
    "MORALIS": {"base": "https://deep-index.moralis.io/api/v3/market-data/price", "weight": 0.8},
}
