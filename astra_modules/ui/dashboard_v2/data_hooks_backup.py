        ...
        if is_crypto:
            ...
            if r.ok:
                ...
                r = requests.get("https://api.twelvedata.com/price",
                                 params={"symbol": symbol, "apikey": api_keys.TWELVEDATA_API_KEY}, timeout=5)
                data = r.json()
            ...
            if r.ok:
                ...
                r = requests.get("https://finnhub.io/api/v1/quote",
                                 params={"symbol": symbol, "token": api_keys.FINNHUB_API_KEY}, timeout=5)
                j = r.json()
...
def get_live_data():
    ...
    symbols = ["AAPL","MSFT","NVDA","TSLA","AMZN","GOOGL",
               "BTCUSD","ETHUSD","SOLUSD","AVAXUSD","BNBUSD","ADAUSD"]
