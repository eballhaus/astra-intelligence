...
st.set_page_config(page_title="Astra Intelligence Dashboard 2.0", layout="wide")

st.title("🧠 Astra Intelligence — Dashboard 2.0")
st.markdown("Real-time engine orchestration, forecasting, and Guardian telemetry.")
