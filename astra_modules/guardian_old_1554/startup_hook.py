...
try:
    ...
    from astra_core.guardian.guardian_engine import GuardianEngine
...
try:
    from astra_core.guardian.telemetry_hub import TelemetryHub
...
def start_astra_system(heartbeat_interval: int = 300):
    ...
    try:
        ...
        try:
            ...
            from astra_core.guardian.alert_manager import \
