...
def fetch_market_data():
    ...
    try:
        # Yahoo Finance unofficial API (fast JSON)
        yahoo_url = (
...
def render_summary():
    """Render top-of-dashboard minimal market overview."""
            ...
            with cols[i]:
                st.markdown(
                    ...
                    <div style="background:rgba(255,255,255,0.03);
                        ...
                        border:1px solid rgba(255,255,255,0.05);color:#9CA3AF;">
                        <b>{label}</b><br>—<br>n/a
                    </div>
                    """,
                    unsafe_allow_html=True,
            ...
            with cols[i]:
                st.markdown(
                    ...
                    <div style="background:rgba(255,255,255,0.03);
                        ...
                        <b style="color:#A7F3D0;">{label}</b><br>
                        <span style="color:#E5E7EB;">{price:,.2f}</span><br>
