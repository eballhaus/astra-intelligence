...
def _load_guardian_core(proxy):
    """Background loader for guardian_v7."""
    ...
    try:
        ...
        # Safely load guardian_v7 without triggering circular imports
        spec = importlib.util.find_spec("guardian.guardian_v7")
        if spec is None:
            raise ImportError("guardian.guardian_v7 not found")
        ...
        if loader is not None:
            ...
            raise ImportError("guardian.guardian_v7 loader not found")
