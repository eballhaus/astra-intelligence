...
class GovernanceCoverageConsolidationTests(unittest.TestCase):
    def test_registry_covers_every_required_domain_once(self):
        ...
        required = {"RUNTIME", "PROCESSES", "RESOURCES", "PROVIDERS", "STORAGE", "INDEXES", "EVIDENCE", "RETRIEVAL", "LANES", "HORIZONS", "LIFECYCLES", "CORTEX", "COPILOT", "BROKER", "RECONCILIATION", "TRUTH", "LEARNING", "REMEDIATION", "SECURITY_AND_SAFETY", "UPGRADE_GOVERNANCE"}
