import types; torch_constraints = types.SimpleNamespace()  # Safe placeholder to avoid circular import
...
def main():
    ...
    try:
        import importlib
        torch_constraints = importlib.import_module("torch.distributions.torch_constraints")
    except Exception:
        class Dummy:
            pass
        torch_constraints = Dummy()
    import importlib
    torch_constraints = importlib.import_module("torch.distributions.torch_constraints")  # safe lazy import
# #     import torch.distributions.torch_constraints as torch_constraints  # moved inside to avoid circular import
