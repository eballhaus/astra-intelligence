...
try:
    from core.guardian.auto_repair import GuardianAutoRepair
    from core.guardian.startup_hook import run_startup_check
    from core.guardian.guardian_import_auditor import run_import_audit
